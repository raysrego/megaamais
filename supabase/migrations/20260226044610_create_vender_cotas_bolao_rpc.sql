/*
  # Create vender_cotas_bolao RPC Function

  1. New RPC Function
    - `vender_cotas_bolao` - Atomic function for selling cotas with optional specific cota ID
  ...
  2. Features
    ...
    - Handles specific cota selection or auto-selection
    - Creates sale record and updates all related tables
    - Returns success status and sale ID
*/

-- Function: Sell Cotas (Individual or Bulk)
